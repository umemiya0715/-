class Dragon < ActiveHash::Base
  self.data = [
    ...
    'このドラゴンが心の中に住んでるあなたは、正に心が燃えている真っ最中。
     ...
     ', advice: 'Twitterの使い方は順調な様子。熱くなりすぎて入れ込みすぎないことだけは注意！' },
    ...
    ', advice: 'ツイートの内容だけに力が入っている様子。認められたければもう少し積極的になった方がいいかも' },
    ...
    その冷静さは絶対零度が如く。'
    , advice: 'ツイート内容は前向きだけど、感情の起伏は小さい模様。' },
    { id: 5, name: 'グレードラゴン', image: 'grayDragon.png', explanation: '毒々しさMAX' ,
    personality:
    'このドラゴンが心の中に住んでるあなたは、ネガティブな感情を周囲に出し過ぎ傾向。
    周りを腐食させる毒のせいで他のドラゴンや人が離れていってしまうかも',
    advice:
    'ネガティブ度が強いツイートを多くしがちな様子。一旦Twitterの使い方を見直して見るのが吉。' },
    { id: 6, name: 'ブルードラゴン', image: 'blueDragon.png', explanation: '怒らすと怖い海の主',
    personality:
    'このドラゴンが心の中に住んでるあなたは、言葉の内に強い感情を秘めている様子。
    海のように、一見穏やかに見えても内には凶暴な感情が見え隠れしている。
    ', advice: 'ツイート頻度は高くないけど、言いたいことが溜まっているかも。Twitter以外で本音を解消できると良し' },
