<template>
  <div class="container mx-auto my-4 term-font text-white px-10 lg:px-60 lg:py-20">
    ...
    <div class="grid grid-rows-1">
      ...
      <div class="text-2xl font-bold mt-10 mb-5">第2条（個人情報の収集方法）</div>
      <p>本ポリシーにおいて、「利用者情報」とは、ユーザーの識別に係る情報、通信サービス上の行動履歴、その他ユーザーのスマートフォン、PC 等の端末においてユーザーまたはユーザーの端末に関連して生成または蓄積された情報であって、本ポリシーに基づき当社が収集するものを意味するものとします。</p>
      <div class="my-3">本サービスにおいて当社が収集する利用者情報は、その収集方法に応じて、以下のようなものとなります。</div>

      <div class="my-3 text-xl font-bold">1. ユーザーからご提供いただく情報</div>
      <div class="my-3">ユーザーが本サービスを利用するために、ご提供いただく情報は以下のとおりです。</div>
      ...
      <div class="my-3 text-xl font-bold">2. ユーザーが本サービスの利用において、他のサービスと連携を許可することにより、当該他のサービスからご提供いただく情報</div>
      <div class="my-3">ユーザーが、本サービスを利用するにあたり、ソーシャルネットワークサービス等の外部サービスとの連携を許可した場合には、その許可の際にご同意いただいた内容に基づき、以下の情報を当該外部サービスから収集します。</div>
      <ul class="ml-5 list-disc">
        <li>当該外部サービスでユーザーが利用するID</li>
        <li>その他当該外部サービスのプライバシー設定によりユーザーが連携先に開示を認めた情報</li>
      </ul>

      <div class="text-2xl font-bold mt-10 mb-5">第3条（個人情報を収集・利用する目的）</div>
      <div class="mb-3">当事務局が個人情報を収集・利用する目的は，以下のとおりです。</div>
      ...
      <div class="text-2xl font-bold mt-10 mb-5">第5条（利用目的の変更）</div>
      <ol class="ml-5 list-decimal">
      ...
      <div class="text-2xl font-bold mt-10 mb-5">第7条（個人情報の開示）</div>
      <ol class="ml-5 list-decimal">
      ...
      <div class="text-2xl font-bold mt-10 mb-5">第8条（個人情報の訂正および削除）</div>
      <ol class="ml-5 list-decimal">
      ...
      <div class="text-2xl font-bold mt-10 mb-5">第9条（個人情報の利用停止等）</div>
      <ol class="ml-5 list-decimal">
      ...
      <div class="text-2xl font-bold mt-10 mb-5">第10条（プライバシーポリシーの変更）</div>
      <ol class="ml-5 list-decimal">
        <li>本ポリシーの内容は，法令その他本ポリシーに別段の定めのある事項を除いて，ユーザーに通知することなく，変更することができるものとします。</li>
        <li>当事務局が別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。</li>
      </ol>

      <div class="text-2xl font-bold mt-10 mb-5">第11条（お問い合わせ窓口）</div>
      <p></p>
