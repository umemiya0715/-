<template>
  <div class="container text-white mt-5 mb-5 font-light">
    ...
    <div class="mb-4">
      <div class="h5">第1条(個人情報)</div>
        「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
    </div>
    <div class='mb-4'>
      <div class='h5'>第2条(取得する情報)</div>
      ...
      <div class='list-decimal mt-2'>
        ...
        <li>当方ウェブサイトの滞在時間、入力履歴等の当方ウェブサイトにおけるお客様の行動履歴</li>
        <li>当方アプリの起動時間、入力履歴等の当方アプリの利用履歴</li>
      </div>
    </div>
    <div class='mb-4'>
      <div class='h5'>第3条(個人情報を収集・利用する目的)</div>
        当方は、ユーザーから取得した情報を、以下の目的のために利用します。
       <div class='list-decimal mt-2'>
        <li>当方サービスに関する登録の受付、ユーザーの本人確認、認証のため</li>
        <li>ユーザーの当方サービスの利用履歴を管理するため</li>
        <li>当方サービスにおけるユーザーの行動履歴を分析し、当方サービスの維持改善に役立てるため</li>
    ...
    <div class='mb-4'>
      <div class='h5'>第5条(禁止事項)</div>
        当方は、ユーザーから取得する情報のうち、個人データ（個人情報保護法第２条第６項）に該当するものついては、あらかじめお客様の同意を得ずに、第三者（日本国外にある者を含みます。）に提供しません。<br>
        但し、次の場合は除きます。
      <div class='list-decimal mt-2'>
    ...
    <div class='mb-4'>
      <div class='h5'>第6条(個人情報の利用停止等)</div>
        ...
        前2項にかかわらず，利用停止等に多額の費用を有する場合その他利用停止等を行うことが困難な場合であって，ユーザーの権利利益を保護するために必要なこれに代わるべ措置をとれる場合は，この代替策を講じるものとします。
    </div>
    <div class='mb-4'>
      <div class='h5'>第7条(アクセス解析ツール)</div>
        当方は、ユーザーのアクセス解析のために、「Googleアナリティクス」を利用しています。
        ...
        Googleアナリティクスについて、詳しくは以下からご確認ください。<br>
    ...
    <div class='mb-4'>
      <div class='h5'>第8条(広告の配信)</div>
        当方は、Google及びそのパートナー（第三者配信事業者）の提供する広告を設置しています。<br>
        広告配信にはCookieを使用し、ユーザーが過去に当方ウェブサイトやその他のサイトにアクセスした情報に基づいて広告を配信します。<br>
        Google やそのパートナーは、Cookieを使用することにより適切な広告を表示しています。<br>
        ユーザーは、以下のGoogleアカウントの広告設定ページから、パーソナライズ広告を無効にできます。<br>
        <a href='https://adssettings.google.com/u/0/authenticated'>https://adssettings.google.com/u/0/authenticated</a><br>
        また aboutads.info のページにアクセスし、パーソナライズ広告掲載に使用される第三者配信事業者のCookieを無効にすることもできます。<br>
    ...
    <div class='mb-4'>
      <div class='h5'>第9条(プライバシーポリシーの変更)</div>
    ...
    <div class='mb-4'>
      <div class='h5'>第11条(お問い合わせ窓口)</div>
    </div>
