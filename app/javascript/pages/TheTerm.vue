<template>
  <div class="text-center">
    <div class="grid grid-cols-12 gap-10 md:pt-10">
      <div class="col-span-10 col-start-2 mt-20 mb-10">
        <div class="inline p-2 text-5xl font-bold text-white md:text-4xl">
          利用規約
        </div>
      </div>
    </div>
    <div class="col-span-10 col-start-2 mx-auto px-10 pb-10 text-center text-white">
      <p class="text-left text-3xl">
        この利用規約（以下，「本規約」といいます。）は、ドラッター（以下，「本サービス提供者」といいます。）がこのウェブサイト上で提供するサービス（以下,「本サービス」といいます。）の利用条件を定めるものです。ユーザーは、本サービスの利用を開始した時点で、本規約の全ての記載内容について同意したものとみなされます。
      </p>

      <div class="mt-20 mb-10 text-4xl font-bold">
        第1条（適用）
      </div>
      <p class="text-left text-3xl">
      ...
      <p class="text-left text-3xl">
        本サービスでは、ユーザーのプライバシー情報と個人情報を、プライバシーポリシーに従って適切に取り扱います。
      </p>

      <div class="mt-20 mb-10 text-4xl font-bold">
        第4条（禁止事項）
      </div>
      <p class="pb-4 text-left text-3xl">
        ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。
      </p>
      <ol class="ml-5 list-decimal text-left text-3xl">
      ...
      <ol class="ml-5 list-decimal pb-4 text-left text-3xl">
      ...
      <div class="mt-20 mb-10 text-left text-4xl font-bold">
        第6条（個人情報の第三者提供）
      </div>
      <p class="pb-4 text-left text-3xl">
      ...
      <p class="text-left text-3xl">
        退会手続きにおいては, 管理者の定める退会手続により本サービスの退会手続きを行うことができるものとします。
      </p>
      ...
      <p class="pb-4 text-left text-3xl">
        ユーザーと本サービス提供者との間の通知または連絡は、本サービス提供者の定める方法によって行うものとします。
      </p>
      <p class="text-left text-3xl">
      ...
      <div class="my-10 text-center text-3xl">
        以上
      </div>
